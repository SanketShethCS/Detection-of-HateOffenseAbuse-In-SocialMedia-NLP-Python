...
and offensive tweets also with added functionality of normalizing the data commented inside the code for both training and validation.
...
for i in labels:
    if i == 1:
        ...
        zero+=1
print("Number of Neither tweets(Train): ",one)
print("Number of Hateful tweets(Train): ",two)
